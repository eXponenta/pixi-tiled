 ...
 */
this.PIXI = this.PIXI || {};
this.PIXI.tiled = this.PIXI.tiled || {};
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pixi/display'), require('@pixi/math'), require('@pixi/core'), require('@pixi/sprite'), require('@pixi/sprite-animated'), require('@pixi/graphics'), require('@pixi/text'), require('@pixi/loaders'), require('@pixi/utils')) :
	typeof define === 'function' && define.amd ? define(['exports', '@pixi/display', '@pixi/math', '@pixi/core', '@pixi/sprite', '@pixi/sprite-animated', '@pixi/graphics', '@pixi/text', '@pixi/loaders', '@pixi/utils'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.pixiv_tiled = {}, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI.utils));
}(this, (function (exports, display$1, math, core, sprite, spriteAnimated, graphics, text, loaders, utils) { 'use strict';
	...
	const Config = {
		defSpriteAnchor: new math.Point(0, 1),
	...
	class TileAnimator {
		...
		constructor(tile) {;TileAnimator.prototype.__init.call(this);
			...
			this._tile = tile;
			this._animator = new spriteAnimated.AnimatedSprite( tile.animation);
	...
	class TiledRect extends math.Rectangle  {constructor(...args) { super(...args); TiledRect.prototype.__init.call(this);TiledRect.prototype.__init2.call(this);TiledRect.prototype.__init3.call(this); }
		__init() {this.name = "";}
		__init2() {this.types = [];}
		__init3() {this.visible = true;}
	}

	class TiledPoint extends math.Point  {
		__init4() {this.name = "";}
		__init5() {this.types = [];}
	...
	class TiledPolygon extends math.Polygon  {
		__init7() {this.name = "";}
		__init8() {this.types = [];}
	...
	class TiledEllipse extends math.Ellipse  {
		__init16() {this.name = "";}
		__init17() {this.types = [];}
	...
	function ApplyMeta(meta, target) {
		...
		if (Config.debugContainers) {
			setTimeout(() => {
				const rect = new graphics.Graphics();
	...
	class TiledSprite extends sprite.Sprite {
	...
	function Build$2(meta) {
		...
		if (meta.gid) {
			...
			( container).hitArea = new math.Rectangle(0, 0, meta.width, meta.height);
		}
	...
	function Build(meta) {
		...
		const text$1 = meta.text;

		let pixiText = new text.Text(text$1.text, {
			wordWrap: text$1.wrap,
			wordWrapWidth: meta.width,
			fill: HexStringToHexInt(text$1.color || "#000000") || 0x000000,
			align: text$1.valign || "top",
			fontFamily: text$1.fontfamily || "sans-serif",
			fontWeight: text$1.bold ? "bold" : "normal",
			fontStyle: text$1.italic ? "italic" : "normal",
			fontSize: text$1.pixelsize || "16px"
		} );
	...
	class TilesetManager extends utils.EventEmitter {
		...
		_tryLoadTexture(url, tile) {
			// @ts-ignore
			const res = new core.ImageResource(url, {
				autoLoad: false,
				crossorigin: 'anonymous',
			});

			const texture = new core.Texture(new core.BaseTexture(res));
	...
	function InjectMixins(pixiPackage) {
	    ...
	    container(display$1.Container);
	    display(display$1.DisplayObject);
...
if (typeof pixiv_tiled !== 'undefined') { Object.assign(this.PIXI.tiled, pixiv_tiled); }
//# sourceMappingURL=pixi-tiled.umd.js.map
